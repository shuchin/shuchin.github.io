...
ninja.data = [{
    ...
    handler: () => {
      ...
      handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-paper-on-adversarial-in-context-learning-icl-accepted-to-neurips-2025-main-conference",
          title: 'Paper on adversarial In-Context Learning (ICL) accepted to NeuRIPS 2025 main conference',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%73%68%75%63%68%69%6E@%65%63%65.%74%75%66%74%73.%65%64%75", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=T7TUmRMAAAAJ&hl=en", "_blank");
        },
      },{
      id: 'light-theme',
